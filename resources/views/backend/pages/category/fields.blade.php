<div class="mb-3">
    ...
    <input type="text" class="form-control" name="category_name" id="category_name"
        placeholder="Please enter a valid category name" value="{{ __old('category_name') }}">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="category_details" id="category_details"
        placeholder="Please enter a valid category details" value="{{ __old('category_details') }}">
    <p class="form-text text-danger mt-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="category_image" id="category_image"
        placeholder="Please enter a valid category image" value="{{ __old('category_image') }}">
    <p class="form-text text-danger mt-3">
