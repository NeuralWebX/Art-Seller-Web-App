...
<body class="bg-light">
    <div class="container">
                ...
                <form action="{{ route('backend.onlinePay.payNow',$product->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                placeholder="Valid customer name is required" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" class="form-control" id="phone"
                                placeholder="Your Mobile number is required." required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control" id="email"
                            placeholder="Please enter a valid email address for shipping updates." required>
                        <div class="invalid-feedback">
                            @error('email')
                            {{ $message }}
                            @enderror
        ...
        <footer class="my-5 pt-5 text-muted text-center text-small">
            <p class="mb-1">&copy; {{ now()->format('Y') }} Company Name</p>
